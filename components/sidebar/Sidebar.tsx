...
export default function Sidebar({ userName, userEmail, userAvatar }: SidebarProps) {
  ...
  return (
    <aside className="w-[220px] shrink-0 flex flex-col h-screen sticky top-0 bg-white border-r border-[#f0eef8]">
      {/* Logo */}
      <div className="px-5 py-6 border-b border-[#f0eef8]">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#6366f1] rounded-xl flex items-center justify-center shadow-md">
            <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
            </svg>
          </div>
          <div>
            <p className="text-sm font-bold text-[#6366f1]">TaskChat</p>
            <p className="text-[10px] text-[#9ca3af]">AI Assistant</p>
          </div>
        </div>
      </div>
